...
plot((ZIM),type ="b",ylim=c(0.000030,0.00015),xlim=c(1,12),ylab = "Z",xlab = "Sample number",col="brown4",pch=16)

abline(h =w0 , col = "red", lty = 2, lwd = 2)
lines(LCL,col="green",lwd=2,lty=2)
lines(UCL,col="blue",lwd=2,lty=2)
legend(2,0.00015,legend = "Z",pch = 16,bty = "n",cex = 0.9,col ="brown4")
legend(3,0.00015,
